...
final class LayoutChoiceTests {
    ...
    func testLayoutChoiceLabels() {
        ...
        #expect(LayoutChoice.diamanti.label == "diamanti")
    ...
    func testLayoutChoiceIcons() {
        ...
        #expect(LayoutChoice.diamanti.icon == "rectangle.split.2x2")
    ...
    func testLayoutChoiceMidiChannel() {
        ...
        #expect(LayoutChoice.diamanti.midiChannel() == 1)
    ...
    func testLayoutChoiceMidiChannelLabel() {
        ...
        #expect(LayoutChoice.diamanti.midiChannelLabel == "2")
