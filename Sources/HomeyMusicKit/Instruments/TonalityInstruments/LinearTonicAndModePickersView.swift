...
public struct LinearTonicAndModePickersView: View {
                ...
                VStack(spacing: 5) {
                    ...
                    if tonalityInstrument.showModePicker {
                        ModePickerInstrumentView(tonalityInstrument: tonalityInstrument)
                            .aspectRatio(
                                TonalityInstrument.horizontalCellCount
                                * tonalityInstrument.modePickerAspectMultiplier,
                                contentMode: .fit
                            )
                    }
                }
    ...
    func modeAndTonicLinkerToggleView(feetDirection: FeetDirection) -> some View {
        Button(action: {
            ...
            .aspectRatio(
                tonalityInstrument.areBothModeLabelsShown ? 0.25 : (1.0 / 3.0),
                contentMode: .fit
            )
            .padding(.vertical, 6)
        }
