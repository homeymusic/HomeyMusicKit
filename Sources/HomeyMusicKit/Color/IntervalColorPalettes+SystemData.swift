...
extension IntervalColorPalette {
    ...
    public static func seedSystemIntervalPalettes(
        ...
        let motorCity = IntervalColorPalette(
            name: "City",
            position: 2,
        ...
        let country = IntervalColorPalette(
            name: "Country",
            position: 3,
            isSystemPalette: false,
        ...
        [IntervalColorPalette.homey, motorCity, country].forEach { systemIntervalColorPalette in
            ...
            if systemPaletteName == IntervalColorPalette.homey.name {
                IntervalColorPalette.homey = systemIntervalColorPalette
            }
        }
    }
}
